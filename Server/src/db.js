...
const { Pokemon, Type, User, Role } = sequelize.models;

// Aca vendrian las relaciones
const TypePokemon = sequelize.define('TypePokemon', { }, { timestamps: false });
...
const UserPokemon = sequelize.define('UserPokemon', { }, { timestamps: false });
